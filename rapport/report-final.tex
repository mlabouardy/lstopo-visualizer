...
\begin{center}
\includegraphics[scale=0.5]{img/registry.png}
\end{center}
...
\begin{itemize}
 \item \textbf{JSLint} est un analyseur de code Javascript. Son but est de parser votre code Javascript pour vérifier que vous respecter les règles de coding Javascript.\newline
 \item \textbf{CSSLint} détecte les problèmes d'une feuille de style CSS.
\end{itemize}
